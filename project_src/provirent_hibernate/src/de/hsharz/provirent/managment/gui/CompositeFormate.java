...
public class CompositeFormate extends AbstractComposite {
    ...
    public CompositeFormate(Composite p, int style, StatusLineStyledText status, Locale l) {
    ...
    private void initVideoFormatGroup() {
        {
            //init a group fro the videoformat
            ...
            {
                sashFormVideoFormat = new SashForm(groupVideoFormat,
                        SWT.NONE);
                ...
                sashFormVideoFormat.setLayoutData(sashForm2LData);
                {
                    groupVideoFormatOverview = new Group(
                            sashFormVideoFormat, SWT.NONE);
                    GridLayout group5Layout = new GridLayout();
                    group5Layout.numColumns = 6;
                    groupVideoFormatOverview.setText(l.getString("videoformat.group.label"));
                    ...
                    //init die Tabelle für die VideoFormate
                    initTableVideoFormat();
                    
                    
                    {
                        labelVideoFormatSearch = new Label(
                                groupVideoFormatOverview, SWT.NONE);
                    ...
                    }
                    {
                        textVideoFormatSearch = new Text(
                                groupVideoFormatOverview, SWT.BORDER);
                ...
                }
                {
                    ...
                    groupVideoFormatDetail.setLayoutData(formData);
                    {
                        labelVideoFormatId = new Label(
                                groupVideoFormatDetail, SWT.NONE);
                    ...
                    }
                    {
                        textVideoFormatID = new Text(
                                groupVideoFormatDetail, SWT.READ_ONLY
                                        | SWT.BORDER);
                    ...
                    }
                    {
                        composite2 = new Composite(
                                groupVideoFormatDetail, SWT.EMBEDDED);
                            ...
                            buttonVideoFormatDelete
                                    .addSelectionListener(new SelectionAdapter() {
                                        public void widgetSelected(
                                            ...
                                            MessageBox messageBox = new MessageBox(parent.getShell(), SWT.ICON_QUESTION |
                                                    SWT.YES | SWT.NO);
                                                    messageBox.setMessage("Wollen Sie den Datensatz löschen?");
                                                    messageBox.setText("Datensatz löschen");
                                            int response = messageBox.open();
                                            
                                            switch(response) {
                                            	case SWT.YES:
                                            	    System.out.println("MessageBox: YES");
                                            	break;
                                            	case SWT.NO:
                                            	    System.out.println("MessageBox: NO");
                                            	break;                                            	
    ...
    private void initAudioFormatGroup() {
        ...
        {
            sashFormAudioFormat = new SashForm(groupAudioFormat,
                    SWT.NONE);
            ...
            sashFormAudioFormat.setLayoutData(sashForm1LData);
            {
                ...
                group3LData.bottom = new FormAttachment(100, 100,
                        -5);
                groupAudioFormatOverview.setLayoutData(group3LData);
                {
                    tableAudioFormat = new Table(
                            groupAudioFormatOverview, SWT.SINGLE
                                    | SWT.FULL_SELECTION
                ...
                }
                {
                    textAudioFormatSearch = new Text(
                            groupAudioFormatOverview, SWT.BORDER);
            ...
            }
            {
                ...
                group4LData.bottom = new FormAttachment(100, 100,
                        -5);
                groupAudioFormatDetail.setLayoutData(group4LData);
                {
                    list1 = new List(groupAudioFormatDetail,
