        ...
        tabFolder1 = new CTabFolder(shell, SWT.CLOSE);
 		...
 		tabFolder1.addCTabFolder2Listener(new CTabFolder2Adapter() {
     		public void close(CTabFolderEvent event) {
     			System.out.println("Es wurde ein Tab geschlossen: "+event.item); 
     		}
     	});        		
	...
	private void initGUI() {
		try {
			...
			shell.setLayout(thisLayout);
            {
                ...
                {
                    tabItemDVD = new CTabItem(tabFolder1, SWT.NONE);
                    tabItemDVD.setText("Dvd");
                }
                {
            ...
            }
			{
...

				{
					...
					viewMenuItem.setText("Ansicht");
					{
						...
						{
						    viewVideoFormatMenuItem = new MenuItem(viewMenu, SWT.CASCADE);
						    viewVideoFormatMenuItem.setText("VideoFormat");
						    viewVideoFormatMenuItem.addListener (SWT.Selection, new Listener () {
								public void handleEvent (Event e) {
								    if (tabItemVideoFormat == null) {
								        System.out.println ("Tab tabItemVideoFormat ist null");    
								    }
								    if (tabItemVideoFormat.isDisposed()) {
								        System.out.println ("Tab tabItemVideoFormat ist Disposed.(nicht mehr vorhanden?)");
								        initTabItemVideoFormat();
								        return;
								    }
								    if (tabItemVideoFormat.isShowing()){
								        System.out.println ("Tab tabItemVideoFormat ist vorhanden.");
								    }
