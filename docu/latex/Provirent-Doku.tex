...
\usepackage{colortbl}
\usepackage[]{graphicx}
%-- dadurch werden zweizeilige Fussnoten eingerückt
\usepackage[hang]{footmisc}
%-- refpage und bei dem Abkürzungsverzeichniss steht die Seite auf der die Abkürzung definiert wird
...
%hier werden die trennungen für spezielle Wörter definiert
\hyphenation{
Hal-lo
}
...
%====================================
%\include{0-1-Titelblatt}
%\include{0-2-Vorwort}
\include{0-3-Verzeichnisse}
%====================================
\include{1-Einfuehrung}
%====================================
\include{2-Aufbau}
%====================================
\include{3-0-Technologien}
\include{3-1-Datenbank}
\include{3-2-Versionsverwaltung}
\include{3-3-Entwicklungsumgebung}
\include{3-4-GUIJava}
\include{3-5-JavaWebanwendungen}
\include{3-6-Persistenzschichten}
%====================================
\include{4-0-Implementierung}
\include{4-1-Versionsverwaltung}
\include{4-2-Entwicklungsumgebung}
\include{4-3-GUIJava}
\include{4-4-JavaWebanwendungen}
\include{4-5-Persistenzschichten}
%====================================
\include{5-Fazit}
%====================================
\include{6-Zusammenfassung}
%====================================
\include{9-0-Anhaenge}
\include{9-1-Literatur}
%\include{9-2-Abkuerzungsverzeichnis}
%\addcontentsline{toc}{chapter}{Index}
%\printindex
%\include{9-3-Erklaerung}
