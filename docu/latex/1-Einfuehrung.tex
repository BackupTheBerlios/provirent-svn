...
Hier wird aufgeschlüsselt, welcher Student welchen Teil der Dokumentation geschrieben hat.\ref{sec:Fazit} \vpagerefrange{sec:Fazit}{sec:Fazit-ende} wurde von allen Studenten bearbeitet.\\[0.1cm]

Remo Griesch bearbeitete die folgenden Kapitel:
\begin{itemize}
	\item \ref{sec:tech-Entwicklungsumgebung} \vpagerefrange{sec:tech-Entwicklungsumgebung}{sec:tech-Entwicklungsumgebung-ende};
	\item \ref{sec:tech-Benutzerschnittstellen} \vpagerefrange{sec:tech-Benutzerschnittstellen}{sec:tech-Benutzerschnittstellen-ende};
	\item \ref{sec:impl-Benutzerschnittstellen}  \vpagerefrange{sec:impl-Benutzerschnittstellen}{sec:impl-Benutzerschnittstellen-ende}
\end{itemize}
...
\begin{itemize}
	\item \ref{sec:tech-struts} \vpagerefrange{sec:tech-struts}{sec:tech-struts-ende};
	\item \ref{sec:tech-hibernate}  \vpagerefrange{sec:tech-hibernate}{sec:tech-hibernate-ende};
	\item \ref{sec:impl-WebAnwendungen} \vpagerefrange{sec:impl-WebAnwendungen}{sec:impl-WebAnwendungen-ende};
	\item \ref{sec:impl-Persistenzschichten}  \vpagerefrange{sec:impl-Persistenzschichten}{sec:impl-Persistenzschichten-ende}
\end{itemize}


Philipp Schneider bearbeitete folgende Kapitel:
\begin{itemize}
	\item \ref{sec:Einfuehrung} \vpagerefrange{sec:Einfuehrung}{sec:Einfuehrung-ende};
	\item \ref{sec:KonzepteundAufbau} \vpagerefrange{sec:KonzepteundAufbau}{sec:KonzepteundAufbau-ende};
	\item \ref{sec:tech-Versionsverwaltung} \vpagerefrange{sec:tech-Versionsverwaltung}{sec:tech-Versionsverwaltung-ende};
	\item \ref{sec:impl-Versionsverwaltung}  \vpagerefrange{sec:impl-Versionsverwaltung}{sec:impl-Versionsverwaltung-ende}
\end{itemize}

\section{Motivation} \label{sec:Motivation}
Im Rahmen des Studiums an der Fachhochschule Harz in Wernigerode muss jeder Student des Studiengangs \emph{Kommunikationsinformatik} eine Projektarbeit abgeben. Dies bedeutet, daß der Student eine Aufgabe (meist Programmieraufgabe) alleine oder in einem kleinen Team bewältigen muss. Die Professoren der Hochschule bieten dabei viele interessante Projektarbeiten an, sind jedoch auf offen für eigene Vorschläge der Studenten.\\
