...
Für die GUI-Erstellung wurde in Eclipse SWT verwendet, da SWT auf die nativen GUI-Komponenten des jeweiligen Betriebssystems zugreift ist Eclipse, trotz Java, nicht als plattformunbhängig zu betrachten.\\
\begin{figure}[htb]
	\centering
...
Die einzelnen Subsysteme definieren Erweiterungs-Schnittstellen um deren Funktionalität der Plattform zugänglich zu machen, wie in Tabelle 3.1 auf Seite \pageref{tab:eclipse-subsystem} zu sehen ist. 
